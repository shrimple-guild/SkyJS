...
const levelData = {
	...
	runecraftingXp: [
		...
		5000, 6200, 7800, 9800, 12200, 15300, 19050
	],
	socialXp: [
...
export const skills = {
	SKILL_FARMING: new Level(levelData.skillXp, 60),
	SKILL_MINING: new Level(levelData.skillXp, 60),
	SKILL_COMBAT: new Level(levelData.skillXp, 60),
	SKILL_FORAGING: new Level(levelData.skillXp, 50),
	SKILL_FISHING: new Level(levelData.skillXp, 50),
	SKILL_ENCHANTING: new Level(levelData.skillXp, 60),
	SKILL_ALCHEMY: new Level(levelData.skillXp, 50),
	SKILL_TAMING: new Level(levelData.skillXp, 60),
	SKILL_CARPENTRY: new Level(levelData.skillXp, 50),
	SKILL_RUNECRAFTING: new Level(levelData.runecraftingXp, 25),
	SKILL_SOCIAL: new Level(levelData.socialXp, 25)
} as const
