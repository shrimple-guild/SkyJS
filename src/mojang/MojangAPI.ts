...
export async function fetchSkin(textureData: MojangTextureData): Promise<Buffer> {
...
export async function fetchAvatar(skin: Buffer) {
...
const textureSteve = Buffer.from(
