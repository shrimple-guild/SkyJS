import { findMilestoneTier, bestiaryFamilies } from "../../constants/bestiary"
import { removeFormatting } from "../../utils/utils"
import { SkyblockBestiaryData } from "../types/SkyblockProfileTypes"
import { APISkyblockMember } from "../types/APIProfileTypes"

export function generateBestiary(member: APISkyblockMember): SkyblockBestiaryData | undefined {
  ...
  const bestiaryMilestone = bestiaryTiers.reduce((sum, mob) => (mob.tier ?? 0) + sum, 0)
  return {
